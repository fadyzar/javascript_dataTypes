...
let  bill = 100;
console.log(`The restaurant bill is ${bill}$`);
...
let  tax= 300;
console.log(`You should pay ${tax} $ for tax`);
...
let bill = 240;
let calc = tax * bill ;
console.log(`Your total bill is ${calc}$`);


// Round the number 50.6 to its nearest integer
let x = Math.round(5.6);
console.log(x);
